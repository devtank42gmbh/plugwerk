...
1. **Parsing** `MANIFEST.MF` — reads both standard PF4J attributes (`Plugin-Id`, `Plugin-Version`, ...) and custom `Plugin-*` attributes (tags, icon, etc.)
...
- Lists (tags, screenshots): max entries (tags 50, screenshots 20), each max 64 characters
